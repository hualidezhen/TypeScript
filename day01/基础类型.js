...
// 或者，全部都采用手动赋值：
(function (Color) {
    Color[Color["Red1"] = 1] = "Red1";
    Color[Color["Green1"] = 2] = "Green1";
    Color[Color["Blue1"] = 4] = "Blue1";
})(Color || (Color = {}));
var c2 = Color.Blue1;
console.log("c2:" + c2); //输出的是2 为枚举的元素编号值
// 5.null和underfined
...
var unusable = undefined; //可以赋值null和underfined，因为他们是void的子类型
// create({ prop: 0 }); // OK
// create(null); // OK
// create(42); // Error
// create("string"); // Error
